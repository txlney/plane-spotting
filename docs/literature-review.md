...
### 2.1 FlightRadar24
FlightRadar24 is one of the most commonly used applications amongst aviation enthusiasts, providing real-time global coverage of aircraft via ADS-B, MLAT, and satellite data. The application details a vast amount of information for every flight - such as aircraft model, route, altitude, and speed - at a reliably accurate rate. In addition, it's easy-to-understand data visualisation features make it a very populator solution for everyone from hardcore aviation enthusiasts, to complete beginners.

With all of this collected data, the platform primarily focuses on aircraft tracking, rather than spotting and logging. Features such as logbooks and collection galleries are not included, whilst some advanced flight details and information are locked behind subscriptions. These limitations present a gap for plane spotters who require a centralised system to track aircraft, as well as log and manage their sightings.
